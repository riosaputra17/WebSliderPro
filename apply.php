...
?>
	...
	<script>
		function tampilkanDialogLogin() {
			var pesan = confirm("Anda perlu melakukan login terlebih dahulu untuk daftar kelas ini");
			if (pesan) {
...
$getdata = mysqli_query($conn, "select * from job where id='$id_job'");
